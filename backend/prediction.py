...
def fit_dynamic_trend(
    ...
    # Fallback to standard column names if not using standardized names
    ...
    return TrendModel(
        ...
        erosion_rate_m_per_yr=round(-slope, 4),  # positive rate = retreating/decreasing
        equation=equation,
        model=model,
        time_col=display_t,
...
def predict_dynamic_future(
    ...
    # Check if last_time_val is an integer year or floating timestamp
    ...
    # Include custom-named columns for convenience
